...
\hline
Sorties & Mise à jour des stocks, statut matière des OF, historique des mouvements, rapports de consommation \\
\hline
\end{tabular}
\end{table}
...
Pour synthétiser la situation actuelle, une carte mentale a été construite (Figure~\ref{fig:carte_mentale}).

\begin{figure}[H]
\centering
\includegraphics[angle=90,width=0.40\textheight,keepaspectratio]{Chapitre2/images/23.png}
\caption{Carte mentale}
\label{fig:carte_mentale}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{Chapitre2/images/IMG_20250614_141256_509.jpg}
